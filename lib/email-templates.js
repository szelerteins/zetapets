...
export function birthdayDiscountTemplate({ userName, petBirthday, discountPct = 10 }) {
  ...
  const expiresDate = new Date(2000, parts[1] - 1, parts[2])
  // Mostrar fecha sin año (simbólica)
  const expiresStr = expiresDate.toLocaleDateString("es-AR", { day: "numeric", month: "long" })
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;max-width:600px;">
          ...
          <tr>
            <td style="padding:32px 40px;">
              ...
              <!-- Discount badge -->
              <div style="background:linear-gradient(135deg,#fef3c7,#fde68a);border:2px solid #f59e0b;border-radius:12px;padding:28px;margin-bottom:28px;text-align:center;">
                ...
                <p style="margin:14px 0 0;font-size:0.85rem;color:#78350f;">Válido hasta el ${expiresStr} · Solo para tu cuenta</p>
              </div>

              <p style="margin:0 0 20px;color:#475569;line-height:1.6;font-size:0.95rem;">
                El descuento se aplica automáticamente cuando iniciás sesión con esta cuenta
                y realizás una compra. No necesitás ningún código.
              </p>
              ...
              <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:8px;padding:16px 20px;">
                <p style="margin:0;font-size:0.85rem;color:#166534;line-height:1.6;">
                  ...
                  3. El 10% se descuenta automáticamente al pagar
                </p>
              </div>
