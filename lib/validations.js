...
export const addToCartSchema = z.object({
  productId: z.union([z.string().uuid(), z.number().int().positive()]).transform(String),
...
export const checkoutSchema = z.object({
  ...
  telefono: z
    ...
    // Requiere al menos 8 dígitos reales (descartando espacios, guiones, paréntesis)
    .refine(
